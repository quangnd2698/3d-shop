        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
                ...
                <ul class="navbar-nav me-auto">
                        ...
                        <div class="dropdown-menu p-4 p-xl-8">
                            <div class="row gy-4">
                                @if (!empty($topCategories))
                                    @foreach ($topCategories as $categoryGroup)
                                        <div class="col-12 col-lg">
                                            <div class="h6 d-flex align-items-center mb-3 mb-lg-4">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <span class="avatar-initial rounded bg-label-primary">
                                                        <i class='{{ $categoryGroup['icon'] }} bx-lg'></i></span>
                                                </div>
                                                <span class="ps-1">{{ $categoryGroup['name'] }}</span>
                                            </div>
                                            <ul class="nav flex-column">
                                                @if (!empty($categoryGroup['items']))
                                                    @foreach ($categoryGroup['items'] as $category)
                                                        <li class="nav-item ">
                                                            <a class="nav-link mega-dropdown-link"
                                                                href="{{ route('site.category', ['slug' => $category['slug']]) }}">
                                ...
                                <div class="col-lg-4 d-none d-lg-block">
                                    <div class="bg-body nav-img-col p-2">
                                        <img src="{{ asset('site/images/menu-banner.png') }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-medium"
                            href="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo-1/front-pages/landing#landingFeatures">Mẫu
                            miễn phí</a>
                    </li>
                    {{-- <li class="nav-item">
                        <a class="nav-link fw-medium"
            ...
            <div class="landing-menu search-header">
                <div class="input-group input-group-merge">
                    ...
                    <input type="text" class="form-control" placeholder="Tìm kiếm..." aria-label="Tìm kiếm..." wire:model="searchKeyword" wire:keydown.enter="search"
                        aria-describedby="basic-addon-search31">
                    <span class="input-group-text pointer" id="basic-addon-search31"  wire:click="search"><i class="bx bx-search"></i></span>
                </div>
            </div>
            <!-- Menu wrapper: End -->
            <!-- Toolbar: Start -->
            <ul class="navbar-nav flex-row align-items-center">
                ...
                <li>
                    <a href="{{ route('site.cart') }}"
                        ...
                        <span class="d-none d-md-block"
                            style="margin-left:5px">Giỏ hảng</span></a>
                </li>
                @auth
                <li>
                    <a href="{{ route('site.order') }}"
                        ...
                        <span class="d-none d-md-block"
                            style="margin-left:5px">Đơn hàng</span></a>
                </li>
                <li class="nav-item dropdown-style-switcher dropdown me-2 me-xl-1">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false">
                            hi <span style="font-weight: bold;margin-left:5px;">{{ ucfirst(current(explode(' ', Auth::user()->username))) }}</span> 
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end dropdown-styles">
                      <li>
                        <a class="dropdown-item" href="javascript:void(0);" data-theme="light">
                ...
                <li>
                    <a href="{{route('site.login')}}"
                        class="btn btn-register-header"><i
                            class='bx bxs-right-arrow-circle'></i><span class="d-none d-md-block"
                            style="margin-left:5px">Đăng nhập</span></a>
                </li>
                @endauth
