        ...
        <div class="authentication-inner">
            ...
            <div class="card px-sm-6 px-0">
                <div class="card-body">
                    ...
                    @endif
                    <div id="formAuthentication" class="mb-6 fv-plugins-bootstrap5 fv-plugins-framework">
                        <div class="mb-6 fv-plugins-icon-container">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" class="form-control" id="email" name="email-username"
                                placeholder="Nhập email của bạn" autofocus="" wire:model='email'>
                            <div
                        ...
                        <div class="mb-6">
                            <button class="btn btn-primary d-grid w-100" wire:click='login()'>Login</button>
                        </div>
                        <input type="hidden">
                      </div>
